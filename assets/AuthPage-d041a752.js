import{u as s,I as D,c as I,b as u,d as _,r as d,a as M,s as R,e as W,j as e,f as A,g as G,l as B,B as P,h as H,N as z}from"./index-71102969.js";import{u as T,B as U,o as Y}from"./yup-f58aefe3.js";const J=s.div`
  height: 100vh;
...
`,te=()=>{var j,x;const a=M(R),r=_(),[y,f]=d.useState({}),[c,m]=d.useState(),[b,v]=d.useState(!1),{register:w,handleSubmit:p,formState:{errors:n,dirtyFields:t}}=T({mode:"onChange",resolver:Y(Z)}),l=i=>{f({...y,[i.target.name]:i.target.value})},h=i=>{m(""),r(B(i)).unwrap().catch(g=>{m(g),P.error(g)})};return e.jsxs("div",{children:[e.jsxs(ee,{action:"",onSubmit:p(h),children:[e.jsxs(q,{children:[e.jsx(k,{type:"email",name:"email",placeholder:"Enter your email",onChange:l,...w("email"),$hasError:!!n.email}),((j=n.email)==null?void 0:j.message)&&t&&e.jsxs(F,{children:[n.email.message," "]})]}),e.jsx(se,{children:e.jsxs(q,{children:[e.jsx(k,{type:b?"text":"password",name:"password",placeholder:"Create a password",onChange:l,...w("password"),$hasError:!!n.password}),((x=n.password)==null?void 0:x.message)&&t&&e.jsx(F,{children:n.password.message}),e.jsx("button",{type:"button",onClick:()=>v(i=>!i),children:b?e.jsx(N,{id:"eye",className:"icon",size:"18"}):e.jsx(N,{id:"eye-off",className:"icon",size:"18"})})]})}),e.jsx(U,{title:"Log In Now",icon:!1})]}),a&&e.jsx(A,{}),c&&e.jsx("div",{children:c})]})},ne=()=>{const{id:a}=H();return e.jsx(J,{children:e.jsxs(K,{children:[e.jsx("nav",{children:e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(z,{to:"/auth/register",children:"Register"})}),e.jsx("li",{children:e.jsx(z,{to:"/auth/login",children:"Login"})})]})}),a==="register"&&e.jsx(X,{}),a==="login"&&e.jsx(te,{})]})})};export{ne as default};

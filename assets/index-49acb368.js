...
`;const u$=k.div`
  ...
  z-index: 9999;
`,Tm=()=>V.jsx(u$,{children:V.jsx(s$,{visible:!0,width:"200",color:"#4fa94d",ariaLabel:"infinity-spin-loading"})}),c$=k.svg`
  stroke: ${e=>e.stroke?e.stroke:e.color};
  fill: ${e=>e.fill?e.fill:e.color};
`,Hv="/goals-achiever-react/assets/sprite-eac431fc.svg",Dl=({id:e,size:t,color:n,stroke:r,fill:o,className:i})=>V.jsx(c$,{width:t,height:t,color:n,stroke:r,fill:o,className:i,children:V.jsx("use",{href:Hv+"#icon-"+e})}),f$=k.div`
  height: 100vh;
  width: 100vw;
  position: absolute;
  left: 0;
...
`,h$=document.querySelector("#rootModal"),i5=({children:e,toggleModal:t,previosModal:n=!1,padding:r="24px"})=>{P.useEffect(()=>{if(n)return;const i=s=>{s.code==="Escape"&&t()};return window.addEventListener("keydown",i),()=>{window.removeEventListener("keydown",i)}},[t,n]);const o=i=>{const{target:s,currentTarget:a}=i;s===a&&t()};return yd.createPortal(V.jsx(f$,{onClick:o,children:V.jsxs(d$,{$padding:r,children:[V.jsx(p$,{onClick:()=>t(),children:V.jsx(Dl,{id:"close",size:9})}),e]})}),h$)},s5=k.div`
  width: 100%;
  height: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
`,Bu={small:{height:"36px",width:"40px",iconSize:20,borderRadius:"8px"},medium:{height:"49px",width:"100%",iconSize:14,borderRadius:"8px"},large:{height:"56px",width:"100%",iconSize:14,borderRadius:"8px"},editProfile:{height:"24px",width:"24px",iconSize:10,borderRadius:"6px"}},a5=k.button`
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
`;var vn=(e=>(e.Without="without",e.Low="low",e.Medium="medium",e.High="high",e))(vn||{});const N5={[vn.Without]:"rgba(125, 125, 125, 1)",[vn.Low]:"#8FA1D0",[vn.Medium]:"#E09CB5",[vn.High]:"#BEDBB0"},D5=[vn.Low,vn.Medium,vn.High,vn.Without],j5=Ao({title:Wt().min(3,"Min length must be more than 3 chars").max(20,"Max length must be less than 20 chars")}),L5=k.div`
  border-radius: 8px;
  font-family: 'Poppins', sans-serif;
  background-color: ${({theme:e})=>e.modalBackground};
  letter-spacing: -0.02em;
...
`,hP=Ao().shape({title:Wt().required("Title name is required")}),GO=({titleModal:e,placeholder:t,actionType:n,id:r,toggleModal:o})=>{var f;const i=Vv(),{register:s,handleSubmit:a,formState:{errors:l,dirtyFields:u}}=R$({mode:"onChange",resolver:N$(hP)}),c=({title:h})=>{switch(n){case"add":i(qs({boardId:r,title:h}));break;case"edit":i(Ks({id:r,newColumnBody:{title:h}}));break;case"delete":i(Qs(r));break}o()};return V.jsx(V.Fragment,{children:V.jsxs(aP,{onSubmit:a(c),children:[V.jsxs(lP,{children:[e.title,n==="delete"&&V.jsx("span",{style:{fontWeight:700},children:t})]}),n!=="delete"&&V.jsxs(uP,{children:[V.jsx(cP,{name:"title",type:"text",placeholder:t,...s("title"),$hasError:!!l.title}),((f=l.title)==null?void 0:f.message)&&u&&V.jsx(pP,{children:l.title.message})]}),n!=="delete"?V.jsxs(I1,{type:"submit",children:[V.jsx(fP,{children:V.jsx(Dl,{id:"plus",size:14,color:"white"})}),e.buttonText]}):V.jsx(dP,{onClick:c,type:"submit",children:e.buttonText})]})})},YO=k.div`
  @media only screen and (min-width: 320px) {
    /* min-width: 240px; */
    width: 100%;
  }
...
`,k4=Ao({title:Wt().required("Title is required"),description:Wt().required("Description is required"),priority:Wt().required("You need to choose the label color"),deadline:m1().required("Deadline is required")}),mP=k.button`
  font-weight: 500;
  font-size: 14px;
  line-height: 1.5;
  letter-spacing: -0.02em;
...
`;var N1=(e=>(e[e.Sunday=0]="Sunday",e[e.Monday=1]="Monday",e[e.Tuesday=2]="Tuesday",e[e.Wednesday=3]="Wednesday",e[e.Thursday=4]="Thursday",e[e.Friday=5]="Friday",e[e.Saturday=6]="Saturday",e))(N1||{}),D1=(e=>(e[e.January=0]="January",e[e.February=1]="February",e[e.March=2]="March",e[e.April=3]="April",e[e.May=4]="May",e[e.June=5]="June",e[e.July=6]="July",e[e.August=7]="August",e[e.September=8]="September",e[e.October=9]="October",e[e.November=10]="November",e[e.December=11]="December",e))(D1||{});function gP(e){const t=new Date;return(r=>{const o=Math.round((r.getTime()-t.getTime())/864e5);return o===0||o<0?"Today":o===1?"Tomorrow":o>1?N1[r.getDay()]:"Unknown Date"})(e)+", "+D1[e.getMonth()]+" "+e.getDate()}const yP=P.forwardRef(({value:e=new Date,isOpen:t,setClose:n},r)=>{const o=new Date(e),[i,s]=P.useState(o),a=gP(i);return P.useEffect(()=>{s(new Date(e))},[e]),V.jsxs(mP,{$degree:t?180:0,ref:r,onMouseDown:l=>{l.preventDefault(),n(!t)},type:"button",children:[a,V.jsx("svg",{width:18,height:18,children:V.jsx("use",{href:`${Hv}#icon-chevron-down`})})]})});yP.displayName="CustomInput";const vP="_datapicker_ol6k9_15",E4={datapicker:vP},C4=k.p`
  font-size: 18px;
  line-height: 1.5;
  letter-spacing: -0.02em;
...
`,D4=k.p`
  ...
  ${e=>`${e.$position};`}
  left: 0;
`,qu=({children:e})=>{const t=eo(Vd),n=ar();return t?e:V.jsx(Sd,{state:{from:n},to:"/welcome"})},Km=({children:e})=>{var r;const t=eo(Vd),n=ar();return t?V.jsx(Sd,{to:((r=n.state)==null?void 0:r.from)||"/"}):e},xP=P.lazy(()=>Ki(()=>import("./WelcomePage-f1be04a2.js"),["assets/WelcomePage-f1be04a2.js","assets/Image-65e15170.js","assets/index-0e05dea9.js"])),wP=P.lazy(()=>Ki(()=>import("./AuthPage-da9e7673.js"),["assets/AuthPage-da9e7673.js","assets/Button-cfe637f3.js"])),SP=P.lazy(()=>Ki(()=>import("./HomePage-16e8a1a7.js"),["assets/HomePage-16e8a1a7.js","assets/ConfirmationPopup-8229bd1a.js","assets/Button-cfe637f3.js","assets/Image-65e15170.js","assets/index-0e05dea9.js"])),Qm=P.lazy(()=>Ki(()=>import("./ScreensPage-e4e4d15a.js"),["assets/ScreensPage-e4e4d15a.js","assets/index-0e05dea9.js","assets/ConfirmationPopup-8229bd1a.js","assets/Button-cfe637f3.js"])),bP=P.lazy(()=>Ki(()=>import("./NotFoundPage-4b8d774a.js"),[]));function _P(){return V.jsx(n2,{children:V.jsxs(dn,{path:"/",element:V.jsx(e$,{}),children:[V.jsx(dn,{index:!0,element:V.jsx(qu,{children:V.jsx(Sd,{to:"/home"})})}),V.jsx(dn,{path:"/welcome",element:V.jsx(Km,{children:V.jsx(xP,{})})}),V.jsx(dn,{path:"/auth/:id",element:V.jsx(Km,{children:V.jsx(wP,{})})}),V.jsxs(dn,{path:"/home",element:V.jsx(SP,{}),children:[V.jsx(dn,{index:!0,element:V.jsx(qu,{children:V.jsx(Qm,{})})}),V.jsx(dn,{path:"/home/:boardName",element:V.jsx(qu,{children:V.jsx(Qm,{})})})]}),V.jsx(dn,{path:"*",element:V.jsx(bP,{})})]})})}Qu.createRoot(document.getElementById("root")).render(V.jsx(c2,{basename:"/goals-achiever-react",children:V.jsx(B2,{store:yv,children:V.jsxs(_0,{loading:null,persistor:BE,children:[V.jsx(_P,{}),V.jsx(ob,{theme:"dark",style:{zIndex:99999},autoClose:2e3})]})})}));export{W5 as $,w5 as A,ae as B,_5 as C,k5 as D,E5 as E,C5 as F,T5 as G,$5 as H,Dl as I,P5 as J,S5 as K,p2 as L,b5 as M,h2 as N,Tu as O,O5 as P,R5 as Q,g5 as R,d5 as S,F5 as T,i5 as U,PE as V,r5 as W,L5 as X,U5 as Y,V5 as Z,H5 as _,eo as a,Iu as a$,G5 as a0,z5 as a1,M5 as a2,B5 as a3,q5 as a4,K5 as a5,Q5 as a6,j5 as a7,Ou as a8,li as a9,hO as aA,xO as aB,vO as aC,wO as aD,SO as aE,bO as aF,_O as aG,A5 as aH,I5 as aI,b4 as aJ,_4 as aK,v4 as aL,x4 as aM,w4 as aN,S4 as aO,ZP as aP,ci as aQ,e2 as aR,Ga as aS,IT as aT,e5 as aU,kO as aV,EO as aW,Hv as aX,CO as aY,$O as aZ,TO as a_,AE as aa,JP as ab,ZC as ac,Y5 as ad,X5 as ae,J5 as af,Z5 as ag,eO as ah,uo as ai,tO as aj,nO as ak,rO as al,oO as am,sO as an,iO as ao,aO as ap,lO as aq,KP as ar,uO as as,fO as at,cO as au,dO as av,pO as aw,mO as ax,gO as ay,yO as az,Wt as b,U0 as b$,PO as b0,OO as b1,RO as b2,FO as b3,N5 as b4,AO as b5,IO as b6,NO as b7,DO as b8,jO as b9,l4 as bA,u4 as bB,c4 as bC,f4 as bD,d4 as bE,p4 as bF,h4 as bG,m4 as bH,g4 as bI,y4 as bJ,yd as bK,Ku as bL,z as bM,Mn as bN,TP as bO,E4 as bP,yP as bQ,C4 as bR,$4 as bS,T4 as bT,P4 as bU,D4 as bV,O4 as bW,R4 as bX,F4 as bY,D5 as bZ,A4 as b_,LO as ba,BO as bb,zO as bc,MO as bd,UO as be,VO as bf,HO as bg,vn as bh,Fu as bi,Au as bj,GO as bk,o5 as bl,YO as bm,JO as bn,ZO as bo,t4 as bp,XO as bq,e4 as br,Ru as bs,ui as bt,n4 as bu,r4 as bv,o4 as bw,i4 as bx,s4 as by,a4 as bz,Ao as c,m5 as c0,I4 as c1,N4 as c2,k4 as c3,WO as c4,qO as c5,KO as c6,QO as c7,s5 as c8,s$ as c9,Bu as ca,a5 as cb,l5 as cc,Vv as d,wd as e,R$ as f,Tm as g,Cu as h,PP as i,V as j,p5 as k,$u as l,h5 as m,Pu as n,N$ as o,u5 as p,c5 as q,P as r,GP as s,XC as t,k as u,f5 as v,YP as w,y5 as x,v5 as y,x5 as z};

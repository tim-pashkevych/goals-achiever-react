...
`;var qt=(e=>(e.Without="without",e.Low="low",e.Medium="medium",e.High="high",e))(qt||{});const _T={[qt.Without]:"rgba(125, 125, 125, 1)",[qt.Low]:"#8FA1D0",[qt.Medium]:"#E09CB5",[qt.High]:"#BEDBB0"},bT=[qt.Low,qt.Medium,qt.High,qt.Without],ET=hi({title:At().min(3,"Min length must be more than 3 chars").max(20,"Max length must be less than 20 chars")}),CT=b.div`
  max-width: 335px;
  border-radius: 8px;
  font-family: 'Poppins', sans-serif;
  background-color: ${({theme:e})=>e.modalBackground};

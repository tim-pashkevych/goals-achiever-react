...
`,qv="/goals-achiever-react/assets/sprite-eac431fc.svg",Il=({id:e,size:t,color:n,stroke:r,fill:o,className:i,pointerEvents:s="auto"})=>V.jsx(m$,{width:t,height:t,color:n,stroke:r,fill:o,className:i,pointerEvents:s,children:V.jsx("use",{href:qv+"#icon-"+e})}),g$=E.div`
  height: 100vh;
  width: 100vw;
  position: absolute;
  left: 0;
...
`,x$=document.querySelector("#rootModal"),mO=({children:e,toggleModal:t,previosModal:n=!1,padding:r="24px"})=>{P.useEffect(()=>{if(n)return;const i=s=>{s.code==="Escape"&&t()};return window.addEventListener("keydown",i),()=>{window.removeEventListener("keydown",i)}},[t,n]);const o=i=>{const{target:s,currentTarget:a}=i;s===a&&t()};return yd.createPortal(V.jsx(g$,{onClick:o,children:V.jsxs(y$,{$padding:r,children:[V.jsx(v$,{onClick:()=>t(),children:V.jsx(Il,{id:"close",size:12})}),e]})}),x$)},gO=E.div`
  ...
  justify-content: center;
  align-items: center;
`,Bu={small:{height:"36px",width:"40px",iconSize:20,borderRadius:"8px"},medium:{height:"49px",width:"100%",iconSize:14,borderRadius:"8px"},large:{height:"56px",width:"100%",iconSize:14,borderRadius:"8px"},editProfile:{height:"24px",width:"24px",iconSize:10,borderRadius:"6px"}},yO=E.button`
...
`;var vn=(e=>(e.Without="without",e.Low="low",e.Medium="medium",e.High="high",e))(vn||{});const qO={[vn.Without]:"rgba(125, 125, 125, 1)",[vn.Low]:"#8FA1D0",[vn.Medium]:"#E09CB5",[vn.High]:"#BEDBB0"},KO=[vn.Low,vn.Medium,vn.High,vn.Without],QO=Ao({title:Wt().min(3,"Min length must be more than 3 chars").max(20,"Max length must be less than 20 chars")}),GO=E.div`
  border-radius: 8px;
  font-family: 'Poppins', sans-serif;
  background-color: ${({theme:e})=>e.modalBackground};
  letter-spacing: -0.02em;
...
`,x5=Ao().shape({email:Wt().email("Enter a valid email").required("Email is required").max(64,"Max length must be less than 64 chars"),message:Wt().required("Message is required").min(3,"Your message should be 3 or more characters")}),LT="/goals-achiever-react/assets/flowerpot_1x-60a66a21.png",BT="/goals-achiever-react/assets/flowerpot_2x-7a0264e5.png",w5=E.div`
  display: flex;
  flex-direction: column;
...
`;var zT={},b1={exports:{}},se={};/*
object-assign
(c) Sindre Sorhus
@license MIT
*/var qm=Object.getOwnPropertySymbols,MT=Object.prototype.hasOwnProperty,UT=Object.prototype.propertyIsEnumerable;function VT(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function HT(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var t={},n=0;n<10;n++)t["_"+String.fromCharCode(n)]=n;var r=Object.getOwnPropertyNames(t).map(function(i){return t[i]});if(r.join("")!=="0123456789")return!1;var o={};return"abcdefghijklmnopqrst".split("").forEach(function(i){o[i]=i}),Object.keys(Object.assign({},o)).join("")==="abcdefghijklmnopqrst"}catch{return!1}}var WT=HT()?Object.assign:function(e,t){for(var n,r=VT(e),o,i=1;i<arguments.length;i++){n=Object(arguments[i]);for(var s in n)MT.call(n,s)&&(r[s]=n[s]);if(qm){o=qm(n);for(var a=0;a<o.length;a++)UT.call(n,o[a])&&(r[o[a]]=n[o[a]])}}return r};/** @license React v16.14.0
 * react.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var cp=WT,Qt=typeof Symbol=="function"&&Symbol.for,Yi=Qt?Symbol.for("react.element"):60103,qT=Qt?Symbol.for("react.portal"):60106,KT=Qt?Symbol.for("react.fragment"):60107,QT=Qt?Symbol.for("react.strict_mode"):60108,GT=Qt?Symbol.for("react.profiler"):60114,YT=Qt?Symbol.for("react.provider"):60109,XT=Qt?Symbol.for("react.context"):60110,JT=Qt?Symbol.for("react.forward_ref"):60112,ZT=Qt?Symbol.for("react.suspense"):60113,eP=Qt?Symbol.for("react.memo"):60115,tP=Qt?Symbol.for("react.lazy"):60116,Km=typeof Symbol=="function"&&Symbol.iterator;function Xi(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var _1={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},k1={};function No(e,t,n){this.props=e,this.context=t,this.refs=k1,this.updater=n||_1}No.prototype.isReactComponent={};No.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error(Xi(85));this.updater.enqueueSetState(this,e,t,"setState")};No.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function E1(){}E1.prototype=No.prototype;function fp(e,t,n){this.props=e,this.context=t,this.refs=k1,this.updater=n||_1}var dp=fp.prototype=new E1;dp.constructor=fp;cp(dp,No.prototype);dp.isPureReactComponent=!0;var pp={current:null},C1=Object.prototype.hasOwnProperty,$1={key:!0,ref:!0,__self:!0,__source:!0};function T1(e,t,n){var r,o={},i=null,s=null;if(t!=null)for(r in t.ref!==void 0&&(s=t.ref),t.key!==void 0&&(i=""+t.key),t)C1.call(t,r)&&!$1.hasOwnProperty(r)&&(o[r]=t[r]);var a=arguments.length-2;if(a===1)o.children=n;else if(1<a){for(var l=Array(a),u=0;u<a;u++)l[u]=arguments[u+2];o.children=l}if(e&&e.defaultProps)for(r in a=e.defaultProps,a)o[r]===void 0&&(o[r]=a[r]);return{$$typeof:Yi,type:e,key:i,ref:s,props:o,_owner:pp.current}}function nP(e,t){return{$$typeof:Yi,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function hp(e){return typeof e=="object"&&e!==null&&e.$$typeof===Yi}function rP(e){var t={"=":"=0",":":"=2"};return"$"+(""+e).replace(/[=:]/g,function(n){return t[n]})}var P1=/\/+/g,Ka=[];function O1(e,t,n,r){if(Ka.length){var o=Ka.pop();return o.result=e,o.keyPrefix=t,o.func=n,o.context=r,o.count=0,o}return{result:e,keyPrefix:t,func:n,context:r,count:0}}function R1(e){e.result=null,e.keyPrefix=null,e.func=null,e.context=null,e.count=0,10>Ka.length&&Ka.push(e)}function wf(e,t,n,r){var o=typeof e;(o==="undefined"||o==="boolean")&&(e=null);var i=!1;if(e===null)i=!0;else switch(o){case"string":case"number":i=!0;break;case"object":switch(e.$$typeof){case Yi:case qT:i=!0}}if(i)return n(r,e,t===""?"."+Wu(e,0):t),1;if(i=0,t=t===""?".":t+":",Array.isArray(e))for(var s=0;s<e.length;s++){o=e[s];var a=t+Wu(o,s);i+=wf(o,a,n,r)}else if(e===null||typeof e!="object"?a=null:(a=Km&&e[Km]||e["@@iterator"],a=typeof a=="function"?a:null),typeof a=="function")for(e=a.call(e),s=0;!(o=e.next()).done;)o=o.value,a=t+Wu(o,s++),i+=wf(o,a,n,r);else if(o==="object")throw n=""+e,Error(Xi(31,n==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":n,""));return i}function Sf(e,t,n){return e==null?0:wf(e,"",t,n)}function Wu(e,t){return typeof e=="object"&&e!==null&&e.key!=null?rP(e.key):t.toString(36)}function oP(e,t){e.func.call(e.context,t,e.count++)}function iP(e,t,n){var r=e.result,o=e.keyPrefix;e=e.func.call(e.context,t,e.count++),Array.isArray(e)?bf(e,r,n,function(i){return i}):e!=null&&(hp(e)&&(e=nP(e,o+(!e.key||t&&t.key===e.key?"":(""+e.key).replace(P1,"$&/")+"/")+n)),r.push(e))}function bf(e,t,n,r,o){var i="";n!=null&&(i=(""+n).replace(P1,"$&/")+"/"),t=O1(t,i,r,o),Sf(e,iP,t),R1(t)}var F1={current:null};function On(){var e=F1.current;if(e===null)throw Error(Xi(321));return e}var sP={ReactCurrentDispatcher:F1,ReactCurrentBatchConfig:{suspense:null},ReactCurrentOwner:pp,IsSomeRendererActing:{current:!1},assign:cp};se.Children={map:function(e,t,n){if(e==null)return e;var r=[];return bf(e,r,null,t,n),r},forEach:function(e,t,n){if(e==null)return e;t=O1(null,null,t,n),Sf(e,oP,t),R1(t)},count:function(e){return Sf(e,function(){return null},null)},toArray:function(e){var t=[];return bf(e,t,null,function(n){return n}),t},only:function(e){if(!hp(e))throw Error(Xi(143));return e}};se.Component=No;se.Fragment=KT;se.Profiler=GT;se.PureComponent=fp;se.StrictMode=QT;se.Suspense=ZT;se.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=sP;se.cloneElement=function(e,t,n){if(e==null)throw Error(Xi(267,e));var r=cp({},e.props),o=e.key,i=e.ref,s=e._owner;if(t!=null){if(t.ref!==void 0&&(i=t.ref,s=pp.current),t.key!==void 0&&(o=""+t.key),e.type&&e.type.defaultProps)var a=e.type.defaultProps;for(l in t)C1.call(t,l)&&!$1.hasOwnProperty(l)&&(r[l]=t[l]===void 0&&a!==void 0?a[l]:t[l])}var l=arguments.length-2;if(l===1)r.children=n;else if(1<l){a=Array(l);for(var u=0;u<l;u++)a[u]=arguments[u+2];r.children=a}return{$$typeof:Yi,type:e.type,key:o,ref:i,props:r,_owner:s}};se.createContext=function(e,t){return t===void 0&&(t=null),e={$$typeof:XT,_calculateChangedBits:t,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null},e.Provider={$$typeof:YT,_context:e},e.Consumer=e};se.createElement=T1;se.createFactory=function(e){var t=T1.bind(null,e);return t.type=e,t};se.createRef=function(){return{current:null}};se.forwardRef=function(e){return{$$typeof:JT,render:e}};se.isValidElement=hp;se.lazy=function(e){return{$$typeof:tP,_ctor:e,_status:-1,_result:null}};se.memo=function(e,t){return{$$typeof:eP,type:e,compare:t===void 0?null:t}};se.useCallback=function(e,t){return On().useCallback(e,t)};se.useContext=function(e,t){return On().useContext(e,t)};se.useDebugValue=function(){};se.useEffect=function(e,t){return On().useEffect(e,t)};se.useImperativeHandle=function(e,t,n){return On().useImperativeHandle(e,t,n)};se.useLayoutEffect=function(e,t){return On().useLayoutEffect(e,t)};se.useMemo=function(e,t){return On().useMemo(e,t)};se.useReducer=function(e,t,n){return On().useReducer(e,t,n)};se.useRef=function(e){return On().useRef(e)};se.useState=function(e){return On().useState(e)};se.version="16.14.0";b1.exports=se;var aP=b1.exports,A1={exports:{}},lP="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",uP=lP,cP=uP;function N1(){}function I1(){}I1.resetWarningCache=N1;var fP=function(){function e(r,o,i,s,a,l){if(l!==cP){var u=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw u.name="Invariant Violation",u}}e.isRequired=e;function t(){return e}var n={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:I1,resetWarningCache:N1};return n.PropTypes=n,n};A1.exports=fP();var dP=A1.exports;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var t=r(aP),n=r(dP);function r(d){return d&&d.__esModule?d:{default:d}}function o(d){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?o=function(y){return typeof y}:o=function(y){return y&&typeof Symbol=="function"&&y.constructor===Symbol&&y!==Symbol.prototype?"symbol":typeof y},o(d)}function i(){return i=Object.assign||function(d){for(var p=1;p<arguments.length;p++){var y=arguments[p];for(var w in y)Object.prototype.hasOwnProperty.call(y,w)&&(d[w]=y[w])}return d},i.apply(this,arguments)}function s(d,p){if(d==null)return{};var y=a(d,p),w,_;if(Object.getOwnPropertySymbols){var k=Object.getOwnPropertySymbols(d);for(_=0;_<k.length;_++)w=k[_],!(p.indexOf(w)>=0)&&Object.prototype.propertyIsEnumerable.call(d,w)&&(y[w]=d[w])}return y}function a(d,p){if(d==null)return{};var y={},w=Object.keys(d),_,k;for(k=0;k<w.length;k++)_=w[k],!(p.indexOf(_)>=0)&&(y[_]=d[_]);return y}function l(d,p){if(!(d instanceof p))throw new TypeError("Cannot call a class as a function")}function u(d,p){for(var y=0;y<p.length;y++){var w=p[y];w.enumerable=w.enumerable||!1,w.configurable=!0,"value"in w&&(w.writable=!0),Object.defineProperty(d,w.key,w)}}function c(d,p,y){return p&&u(d.prototype,p),y&&u(d,y),d}function f(d,p){return p&&(o(p)==="object"||typeof p=="function")?p:h(d)}function h(d){if(d===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return d}function x(d){return x=Object.setPrototypeOf?Object.getPrototypeOf:function(y){return y.__proto__||Object.getPrototypeOf(y)},x(d)}function g(d,p){if(typeof p!="function"&&p!==null)throw new TypeError("Super expression must either be null or a function");d.prototype=Object.create(p&&p.prototype,{constructor:{value:d,writable:!0,configurable:!0}}),p&&v(d,p)}function v(d,p){return v=Object.setPrototypeOf||function(w,_){return w.__proto__=_,w},v(d,p)}var b=function(d){g(p,d);function p(y){var w;return l(this,p),w=f(this,x(p).call(this,y)),w.state={},w}return c(p,[{key:"render",value:function(){var w=this.props,_=w.text,k=w.length,C=w.tail,F=w.tailClassName,D=s(w,["text","length","tail","tailClassName"]);if(_.length<=this.props.length||this.props.length<0)return t.default.createElement("span",D,this.props.text);var W={cursor:"auto"},M;return k-C.length<=0?M="":M=_.slice(0,k-C.length),t.default.createElement("span",i({title:this.props.text},D),M,t.default.createElement("span",{style:W,className:F},C))}}]),p}(t.default.Component);b.propTypes={text:n.default.string.isRequired,length:n.default.number.isRequired,tail:n.default.string,tailClassName:n.default.string},b.defaultProps={tail:"...",tailClassName:"more"};var m=b;e.default=m})(zT);function mp(e){const t=Object.prototype.toString.call(e);return e instanceof Date||typeof e=="object"&&t==="[object Date]"?new e.constructor(+e):typeof e=="number"||t==="[object Number]"||typeof e=="string"||t==="[object String]"?new Date(e):new Date(NaN)}function D1(e,t){return e instanceof Date?new e.constructor(t):new Date(t)}function pP(e,t){const n=mp(e);return isNaN(t)?D1(e,NaN):(t&&n.setDate(n.getDate()+t),n)}function Qm(e){const t=mp(e);return t.setHours(0,0,0,0),t}function j1(e){return D1(e,Date.now())}function L1(e,t){const n=Qm(e),r=Qm(t);return+n==+r}function hP(e){return mp(e).getDay()}function mP(e){return L1(e,j1(e))}function gP(e){return L1(e,pP(j1(e),1))}const I5=E.div`
  position: relative;
...
`,_P=E(Il)`
  fill: none;
  stroke: ${({theme:e})=>e.buttonIconColor};
`,kP=Ao().shape({title:Wt().required("Title name is required")}),n4=({titleModal:e,placeholder:t,actionType:n,id:r,toggleModal:o})=>{const i=Wv(),{register:s,handleSubmit:a,formState:{errors:l,dirtyFields:u}}=D$({mode:"onChange",resolver:z$(kP)}),c=({title:f})=>{switch(n){case"add":i(qs({boardId:r,title:f}));break;case"edit":i(Ks({id:r,newColumnBody:{title:f}}));break}o()};return V.jsx(V.Fragment,{children:V.jsxs(yP,{onSubmit:a(c),children:[V.jsx(vP,{children:e.title}),V.jsxs(xP,{children:[V.jsx(wP,{name:"title",type:"text",placeholder:t,...s("title"),$hasError:!!l.title}),l.title&&u&&V.jsx(bP,{children:l.title.message})]}),V.jsxs(B1,{type:"submit",children:[V.jsx(SP,{children:V.jsx(_P,{id:"plus",size:14})}),e.buttonText]})]})})},r4=E.div`
  width: 89vw;
  padding-bottom: 24px;
  @media only screen and (min-width: 375px) {
    width: 347px;
...
`,R4=Ao({title:Wt().required("Title is required"),description:Wt().required("Description is required"),priority:Wt().required("You need to choose the label color"),deadline:y1().required("Deadline is required")}),EP=E.button`
  font-weight: 500;
  font-size: 14px;
  line-height: 1.5;
  letter-spacing: -0.02em;
...
`,qu=({children:e})=>{const t=eo(Vd),n=ar();return t?e:V.jsx(Sd,{state:{from:n},to:"/welcome"})},Gm=({children:e})=>{var r;const t=eo(Vd),n=ar();return t?V.jsx(Sd,{to:((r=n.state)==null?void 0:r.from)||"/"}):e},PP=P.lazy(()=>Ki(()=>import("./WelcomePage-40369495.js"),["assets/WelcomePage-40369495.js","assets/Image-74e5cb8a.js"])),OP=P.lazy(()=>Ki(()=>import("./AuthPage-38fcd2b2.js"),["assets/AuthPage-38fcd2b2.js","assets/Button-d5d42117.js"])),RP=P.lazy(()=>Ki(()=>import("./HomePage-b28fae2f.js"),["assets/HomePage-b28fae2f.js","assets/ConfirmationPopup-33058181.js","assets/Image-74e5cb8a.js","assets/Button-d5d42117.js"])),Ym=P.lazy(()=>Ki(()=>import("./ScreensPage-2d9df18f.js"),["assets/ScreensPage-2d9df18f.js","assets/Image-74e5cb8a.js","assets/ConfirmationPopup-33058181.js","assets/Button-d5d42117.js"])),FP=P.lazy(()=>Ki(()=>import("./NotFoundPage-ed82b419.js"),[]));function AP(){return V.jsx(a2,{children:V.jsxs(dn,{path:"/",element:V.jsx(i$,{}),children:[V.jsx(dn,{index:!0,element:V.jsx(qu,{children:V.jsx(Sd,{to:"/home"})})}),V.jsx(dn,{path:"/welcome",element:V.jsx(Gm,{children:V.jsx(PP,{})})}),V.jsx(dn,{path:"/auth/:id",element:V.jsx(Gm,{children:V.jsx(OP,{})})}),V.jsxs(dn,{path:"/home",element:V.jsx(RP,{}),children:[V.jsx(dn,{index:!0,element:V.jsx(qu,{children:V.jsx(Ym,{})})}),V.jsx(dn,{path:"/home/:boardName",element:V.jsx(qu,{children:V.jsx(Ym,{})})})]}),V.jsx(dn,{path:"*",element:V.jsx(FP,{})})]})})}Qu.createRoot(document.getElementById("root")).render(V.jsx(m2,{basename:"/goals-achiever-react",children:V.jsx(H2,{store:xv,children:V.jsxs(E0,{loading:null,persistor:HE,children:[V.jsx(AP,{}),V.jsx(ub,{theme:"dark",style:{zIndex:99999},autoClose:2e3})]})})}));export{a5 as $,TO as A,ae as B,PO as C,OO as D,RO as E,NO as F,IO as G,DO as H,Il as I,jO as J,BO as K,v2 as L,LO as M,x2 as N,zO as O,FO as P,AO as Q,$O as R,bO as S,$u as T,MO as U,UO as V,VO as W,mO as X,LE as Y,lO as Z,o$ as _,eo as a,J5 as a$,d5 as a0,p5 as a1,h5 as a2,m5 as a3,y5 as a4,g5 as a5,v5 as a6,x5 as a7,rO as a8,w5 as a9,Qa as aA,zT as aB,mp as aC,D1 as aD,Qm as aE,pP as aF,cO as aG,I5 as aH,D5 as aI,qv as aJ,j5 as aK,L5 as aL,B5 as aM,Nu as aN,z5 as aO,M5 as aP,U5 as aQ,V5 as aR,qO as aS,H5 as aT,W5 as aU,q5 as aV,K5 as aW,Q5 as aX,G5 as aY,Y5 as aZ,X5 as a_,b5 as aa,S5 as ab,_5 as ac,k5 as ad,C5 as ae,$5 as af,T5 as ag,E5 as ah,O5 as ai,P5 as aj,R5 as ak,F5 as al,A5 as am,uo as an,N5 as ao,HO as ap,WO as aq,P4 as ar,O4 as as,E4 as at,C4 as au,$4 as av,T4 as aw,uO as ax,ci as ay,i2 as az,Wt as b,n5 as b$,Z5 as b0,e4 as b1,t4 as b2,vn as b3,Fu as b4,Au as b5,n4 as b6,fO as b7,hO as b8,r4 as b9,z as bA,Mn as bB,LP as bC,L1 as bD,hP as bE,F4 as bF,$P as bG,A4 as bH,N4 as bI,I4 as bJ,D4 as bK,V4 as bL,j4 as bM,L4 as bN,B4 as bO,KO as bP,z4 as bQ,H0 as bR,CO as bS,M4 as bT,U4 as bU,R4 as bV,pO as bW,GO as bX,ZO as bY,e5 as bZ,t5 as b_,i4 as ba,s4 as bb,l4 as bc,o4 as bd,a4 as be,Ou as bf,Ru as bg,ui as bh,u4 as bi,c4 as bj,f4 as bk,d4 as bl,p4 as bm,h4 as bn,m4 as bo,g4 as bp,y4 as bq,v4 as br,x4 as bs,w4 as bt,S4 as bu,b4 as bv,_4 as bw,k4 as bx,yd as by,Ku as bz,Ao as c,s5 as c0,XO as c1,JO as c2,YO as c3,r5 as c4,o5 as c5,i5 as c6,QO as c7,Pu as c8,li as c9,l5 as ca,u5 as cb,c5 as cc,f5 as cd,gO as ce,f$ as cf,Bu as cg,yO as ch,vO as ci,Wv as d,jT as e,wd as f,D$ as g,Pm as h,Eu as i,V as j,BP as k,Cu as l,NE as m,_O as n,z$ as o,EO as p,kO as q,P as r,iO as s,n$ as t,E as u,Tu as v,xO as w,wO as x,SO as y,sO as z};

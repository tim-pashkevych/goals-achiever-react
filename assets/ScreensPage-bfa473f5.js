import{j as e,ac as c,ad as d,ae as p,I as r,r as h,af as x,ag as m,ah as u,ai as j,aj as g,ak as b,al as S,am as f,an as v,ao as w,ap as k,aq as _,u as n,c as $,M as y}from"./index-fda43bb5.js";import{u as A}from"./useModal-8742b927.js";const F=[{title:"without priority",color:"rgba(125, 125, 125, 1)"},{title:"low",color:"#8fa1d0"},{title:"medium",color:"#e09cb5"},{title:"high",color:"#bedbb0"}],M=()=>e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Project office"}),e.jsxs(d,{children:[e.jsx(p,{children:e.jsx(r,{id:"plus",size:14})}),"Add another column"]})]}),z=()=>{const[t,a]=h.useState(null),o=s=>{s!==t&&a(s)},i=()=>{a(null)};return console.log(t),e.jsxs(x,{children:[e.jsx(m,{children:"Filters"}),e.jsxs(u,{children:[e.jsx(j,{children:"Label color"}),e.jsx(g,{onClick:i,children:"show all"})]}),e.jsx(b,{children:F.map((s,l)=>e.jsx(S,{children:e.jsxs(f,{onClick:()=>o(s.title),className:`${t===s.title?"active":""}`,children:[e.jsx(v,{className:`${t===s.title?"active":""}`,$color:s.color}),s.title]})},l))})]})},I=()=>e.jsx(w,{children:e.jsxs(k,{children:["Before starting your project, it is essential",e.jsx(_,{href:"#",children:" to create a board"})," to visualize and track all the necessary tasks and milestones. This board serves as a powerful tool to organize the workflow and ensure effective collaboration among team members."]})}),N=n.div`
  position: relative;

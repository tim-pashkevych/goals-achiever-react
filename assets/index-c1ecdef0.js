...
`,x$=document.querySelector("#rootModal"),hO=({children:e,toggleModal:t,previosModal:n=!1,padding:r="24px"})=>{P.useEffect(()=>{if(n)return;const i=s=>{s.code==="Escape"&&t()};return window.addEventListener("keydown",i),()=>{window.removeEventListener("keydown",i)}},[t,n]);const o=i=>{const{target:s,currentTarget:a}=i;s===a&&t()};return yd.createPortal(V.jsx(g$,{onClick:o,children:V.jsxs(y$,{$padding:r,children:[V.jsx(v$,{onClick:()=>t(),children:V.jsx(Dl,{id:"close",size:9})}),e]})}),x$)},mO=k.div`
  ...
  justify-content: center;
  align-items: center;
`,Bu={small:{height:"36px",width:"40px",iconSize:20,borderRadius:"8px"},medium:{height:"49px",width:"100%",iconSize:14,borderRadius:"8px"},large:{height:"56px",width:"100%",iconSize:14,borderRadius:"8px"},editProfile:{height:"24px",width:"24px",iconSize:10,borderRadius:"6px"}},gO=k.button`
...
`,_P=Ao().shape({title:Wt().required("Title name is required")}),o4=({titleModal:e,placeholder:t,actionType:n,id:r,toggleModal:o})=>{var f;const i=Wv(),{register:s,handleSubmit:a,formState:{errors:l,dirtyFields:u}}=D$({mode:"onChange",resolver:z$(_P)}),c=({title:h})=>{switch(n){case"add":i(qs({boardId:r,title:h}));break;case"edit":i(Ks({id:r,newColumnBody:{title:h}}));break;case"delete":i(Qs(r));break}o()};return V.jsx(V.Fragment,{children:V.jsxs(gP,{onSubmit:a(c),children:[V.jsxs(yP,{children:[e.title,n==="delete"&&V.jsx("span",{style:{fontWeight:700},children:t})]}),n!=="delete"&&V.jsxs(vP,{children:[V.jsx(xP,{name:"title",type:"text",placeholder:t,...s("title"),$hasError:!!l.title}),((f=l.title)==null?void 0:f.message)&&u&&V.jsx(bP,{children:l.title.message})]}),n!=="delete"?V.jsxs(B1,{type:"submit",children:[V.jsx(wP,{children:V.jsx(Dl,{id:"plus",size:14,color:"white"})}),e.buttonText]}):V.jsx(SP,{onClick:c,type:"submit",children:e.buttonText})]})})},i4=k.div`
  @media only screen and (min-width: 320px) {
    /* min-width: 240px; */
    width: 100%;
  }
...
`,A4=Ao({title:Wt().required("Title is required"),description:Wt().required("Description is required"),priority:Wt().required("You need to choose the label color"),deadline:y1().required("Deadline is required")}),kP=k.button`
  font-weight: 500;
  font-size: 14px;
  line-height: 1.5;
  letter-spacing: -0.02em;
...
`,W4=k.p`
  ...
  ${e=>`${e.$position};`}
  left: 0;
`,qu=({children:e})=>{const t=eo(Vd),n=ar();return t?e:V.jsx(Sd,{state:{from:n},to:"/welcome"})},Gm=({children:e})=>{var r;const t=eo(Vd),n=ar();return t?V.jsx(Sd,{to:((r=n.state)==null?void 0:r.from)||"/"}):e},TP=P.lazy(()=>Ki(()=>import("./WelcomePage-3da90dc5.js"),["assets/WelcomePage-3da90dc5.js","assets/Image-ea74df02.js","assets/index-0e05dea9.js"])),PP=P.lazy(()=>Ki(()=>import("./AuthPage-c5771e73.js"),["assets/AuthPage-c5771e73.js","assets/Button-59ff0b64.js"])),OP=P.lazy(()=>Ki(()=>import("./HomePage-c94411d8.js"),["assets/HomePage-c94411d8.js","assets/ConfirmationPopup-2a0ee031.js","assets/Button-59ff0b64.js","assets/Image-ea74df02.js","assets/index-0e05dea9.js"])),Ym=P.lazy(()=>Ki(()=>import("./ScreensPage-0d487237.js"),["assets/ScreensPage-0d487237.js","assets/index-0e05dea9.js","assets/ConfirmationPopup-2a0ee031.js","assets/Button-59ff0b64.js"])),RP=P.lazy(()=>Ki(()=>import("./NotFoundPage-c4a83aa5.js"),[]));function FP(){return V.jsx(a2,{children:V.jsxs(dn,{path:"/",element:V.jsx(i$,{}),children:[V.jsx(dn,{index:!0,element:V.jsx(qu,{children:V.jsx(Sd,{to:"/home"})})}),V.jsx(dn,{path:"/welcome",element:V.jsx(Gm,{children:V.jsx(TP,{})})}),V.jsx(dn,{path:"/auth/:id",element:V.jsx(Gm,{children:V.jsx(PP,{})})}),V.jsxs(dn,{path:"/home",element:V.jsx(OP,{}),children:[V.jsx(dn,{index:!0,element:V.jsx(qu,{children:V.jsx(Ym,{})})}),V.jsx(dn,{path:"/home/:boardName",element:V.jsx(qu,{children:V.jsx(Ym,{})})})]}),V.jsx(dn,{path:"*",element:V.jsx(RP,{})})]})})}Qu.createRoot(document.getElementById("root")).render(V.jsx(m2,{basename:"/goals-achiever-react",children:V.jsx(H2,{store:xv,children:V.jsxs(E0,{loading:null,persistor:HE,children:[V.jsx(FP,{}),V.jsx(ub,{theme:"dark",style:{zIndex:99999},autoClose:2e3})]})})}));export{e5 as $,PO as A,ae as B,FO as C,AO as D,NO as E,IO as F,jO as G,DO as H,Dl as I,LO as J,OO as K,v2 as L,RO as M,x2 as N,Tu as O,BO as P,zO as Q,EO as R,SO as S,MO as T,hO as U,NE as V,dO as W,KO as X,XO as Y,JO as Z,ZO as _,eo as a,qv as a$,o5 as a0,GO as a1,YO as a2,QO as a3,t5 as a4,n5 as a5,r5 as a6,qO as a7,Ou as a8,li as a9,_5 as aA,T5 as aB,$5 as aC,P5 as aD,O5 as aE,R5 as aF,F5 as aG,UO as aH,VO as aI,R4 as aJ,F4 as aK,$4 as aL,T4 as aM,P4 as aN,O4 as aO,lO as aP,ci as aQ,i2 as aR,Ga as aS,BT as aT,mp as aU,D1 as aV,Qm as aW,dP as aX,uO as aY,A5 as aZ,N5 as a_,LE as aa,aO as ab,o$ as ac,i5 as ad,s5 as ae,a5 as af,l5 as ag,u5 as ah,uo as ai,c5 as aj,f5 as ak,d5 as al,p5 as am,m5 as an,h5 as ao,g5 as ap,y5 as aq,nO as ar,v5 as as,w5 as at,x5 as au,S5 as av,b5 as aw,k5 as ax,E5 as ay,C5 as az,Wt as b,W4 as b$,I5 as b0,D5 as b1,j5 as b2,Nu as b3,L5 as b4,B5 as b5,z5 as b6,M5 as b7,HO as b8,U5 as b9,p4 as bA,h4 as bB,m4 as bC,g4 as bD,y4 as bE,v4 as bF,x4 as bG,w4 as bH,S4 as bI,b4 as bJ,_4 as bK,k4 as bL,E4 as bM,C4 as bN,yd as bO,Ku as bP,z as bQ,Mn as bR,jP as bS,L1 as bT,pP as bU,N4 as bV,CP as bW,I4 as bX,D4 as bY,j4 as bZ,L4 as b_,V5 as ba,H5 as bb,W5 as bc,q5 as bd,K5 as be,Q5 as bf,G5 as bg,Y5 as bh,X5 as bi,J5 as bj,Z5 as bk,vn as bl,Fu as bm,Au as bn,o4 as bo,pO as bp,i4 as bq,a4 as br,l4 as bs,c4 as bt,s4 as bu,u4 as bv,Ru as bw,ui as bx,f4 as by,d4 as bz,Ao as c,B4 as c0,z4 as c1,M4 as c2,WO as c3,U4 as c4,H0 as c5,kO as c6,V4 as c7,H4 as c8,A4 as c9,e4 as ca,t4 as cb,n4 as cc,r4 as cd,mO as ce,f$ as cf,Bu as cg,gO as ch,yO as ci,Wv as d,wd as e,D$ as f,Pm as g,Cu as h,LP as i,V as j,bO as k,$u as l,_O as m,Pu as n,z$ as o,vO as p,xO as q,P as r,oO as s,n$ as t,k as u,wO as v,iO as w,CO as x,$O as y,TO as z};
